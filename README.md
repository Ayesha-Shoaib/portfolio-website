...
* **Models Used:** S Learner, T Learner, and X Learner.
* **Key Tech:** Python, XGBoost, Streamlit, Plotly.
* **Business Impact:** I found an optimal targeting threshold of 69 percent. This reduces marketing waste while keeping incremental revenue.


---

## Future Projects
* **Customer Lifetime Value Prediction:** Predicting long term value with probabilistic models.
* **Inventory Optimization:** A time series tool for stock management.
